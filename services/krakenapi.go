...
const (
	...
	APIUserAgent = "Kraken GO API Agent (https://github.com/beldur/services-go-api-client)"
)
...
func (api *KrakenAPI) DepositAddresses(asset string, method string, new string) (*DepositAddressesResponse, error) {
